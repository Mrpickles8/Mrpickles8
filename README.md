...
- <a href="https://github.com/Mrpickles8/Summit/tree/main">Summit</a> - Simulated the role of a SOC analyst responding to escalating alerts within a simulated environment. The goal was to triage alerts, investigate malicious activity, and implement defensive measures to stop an active attack campaign, applying the Pyramid of Pain framework.
